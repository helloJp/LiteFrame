...
import org.jp.liteframe.utils.DensityUtils;
import org.jp.liteframe.utils.StringUtils;
import org.jp.liteframe.utils.SystemTool;
...
public class ViewInject {
    ...
    public static void toast(String msg) {
        try {
            toast(LiteActivityStack.create().topActivity(), msg);
        } catch (Exception e) {
        }
    }
    ...
    public static void longToast(String msg) {
        try {
            longToast(LiteActivityStack.create().topActivity(), msg);
        } catch (Exception e) {
        }
    }
