 ...
 * @version 1.6
 */
public abstract class LiteFragment extends Fragment implements View.OnClickListener {

    public static final int WHICH_MSG = 0X37211;

    protected View fragmentRootView;
    private ThreadDataCallBack callback;
    private LiteFragmentHandle threadHandle = new LiteFragmentHandle(this);
    ...
    private static class LiteFragmentHandle extends Handler {
        private final SoftReference<LiteFragment> mOuterInstance;

        LiteFragmentHandle(LiteFragment outer) {
        ...
        public void handleMessage(android.os.Message msg) {
            LiteFragment liteFragment = mOuterInstance.get();
            if (msg.what == WHICH_MSG && liteFragment != null) {
                liteFragment.callback.onSuccess();
            }
        }
    }
